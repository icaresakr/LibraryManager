                ...
                <c:choose>
                  <c:when test="${id != null && !currentLoan.isEmpty()}">
                    <c:forEach items="${currentLoan}" var="loan">
                      <option value="${id}">"${loan.livre.titre}", emprunté par ${loan.membre.prenom} ${loan.membre.nom}</option>
                    </c:forEach>
                  </c:when>
                  <c:otherwise>
                    ...
                    <c:if test="${!currentLoan.isEmpty()}">
                      <c:forEach items="${currentLoan}" var="loan">
                        <option value="${loan.id}">"${loan.livre.titre}", emprunté par ${loan.membre.prenom} ${loan.membre.nom}</option>
                      </c:forEach>
                    </c:if>
                  </c:otherwise>
                </c:choose>
