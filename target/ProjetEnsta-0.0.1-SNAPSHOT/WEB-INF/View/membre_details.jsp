        ...
        <div class="row">
	      <form action="membre_details?id=${membre.id}" method="post" class="col s12"> 
	        ...
	        <div class="row">
	          ...
	          <div class="input-field col s6">
	            <input id="telephone" type="tel" value=${membre.tel} name="telephone"> <!-- TODO : remplacer telephoneDuMembre par le t�l�phone du membre -->
              ...
              <tbody id="results">
				...
				<c:if test="${!currentByMember.isEmpty()}">
					<c:forEach items="${currentByMember}" var="current">
						<tr>
						<td>"${current.livre.titre}" de ${current.livre.auteur}</td>
